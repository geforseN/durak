<template>
  ...
  <div
    class="flex w-full justify-evenly gap-x-0 xxs:gap-x-2 xs:gap-x-4 xs:px-2"
  >
...
import GameBoard from "$/card-game/components/game/GameBoard.vue";
