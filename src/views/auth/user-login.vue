<template>
  <div class="min-h-[80vh] flex justify-center items-center">
    <form class="flex flex-col gap-y-6 w-[40rem]">
      ...
      <labeled-input id="login-accname" v-model="accname" required
        >Имя аккаунта</labeled-input
      >
      <labeled-input
        id="login-password"
        v-model="password"
      ...
      <div class="flex justify-between gap-5">
        <a
          href="https://github.com/login/oauth/authorize?scope=user:email&client_id=a70a29b2c24bce09f9eb"
          class="border-black border-2 flex-1 bg-slate-500 btn text-white text-xl w-fit self-end hover:bg-slate-600"
          >GitHub</a
        >
        <a
          ...
          class="border-black border-2 flex-1 bg-blue-700 btn text-white text-xl w-fit self-end hover:bg-slate-600"
          >VK</a
        >
        <a
          ...
          class="border-black border-2 flex-1 bg-purple-700 btn text-white text-xl w-fit self-end hover:bg-slate-600"
          >Twitch</a
        >
      </div>
